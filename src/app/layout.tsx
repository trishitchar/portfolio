...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		url: siteUrl,
		title: siteName,
		description: 'Trishit Char (@trishitchar) — Full-Stack Developer & UI/UX Designer. Check out projects, blog posts, and case studies.',
		siteName,
	...
	twitter: {
		...
		creator: '@trishitchar',
		title: siteName,
		description: "Explore Trishit Char's (@trishitchar) portfolio — Full-Stack Developer & UI/UX Designer.",
